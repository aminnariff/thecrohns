...
class Task extends Model {
  ...
  const Task._internal({required this.id, name, description, isComplete, createdAt, updatedAt}): _name = name, _description = description, _isComplete = isComplete, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Task({String? id, String? name, String? description, bool? isComplete}) {
  ...
  Task copyWith({String? name, String? description, bool? isComplete}) {
    return Task._internal(
      id: id,
      name: name ?? this.name,
